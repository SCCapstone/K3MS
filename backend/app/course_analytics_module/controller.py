...
def get_courses_for_user_controller(user_email, period):
    try:
        ...
        return dict(error="Error retrieving courses"), HTTPStatus.INTERNAL_SERVER_ERROR
...
def get_course_analytics_controller(course_name, period):
    ...
    try:
        ...
        return {'error': 'Error retrieving anonymous data'}, HTTPStatus.INTERNAL_SERVER_ERROR
...
def get_all_courses_in_db_controller():
    try:
        ...
        return {'error': 'Error retrieving courses'}, HTTPStatus.INTERNAL_SERVER_ERROR
...
def get_users_in_chairs_dept_controller():
    try:
        ...
        return {'error': 'Error retrieving users'}, HTTPStatus.INTERNAL_SERVER_ERROR
